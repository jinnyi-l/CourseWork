...
def checkout_and_payment(login_info) -> None:
    ...
    try:
        ...
        print(f"Missing required login information: {e}")
        raise
    except TypeError as e:
        print(f"Invalid login information: {e}")
        raise
    ...
    while True:
        ...
        if choice.startswith('d'):
            ...
            if check_cart(user=user, cart=global_cart) is False:
            ...
            else: # TODO: Task 4: update the wallet information in the users.json file
                ...
                print(f"Wallet information for user '{user.name}' successfully updated!")
